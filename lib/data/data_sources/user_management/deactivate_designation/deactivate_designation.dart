...
@lazySingleton
class DeactivateDesignation {
  final HttpClient httpClient;
  final RunSafely runSafely;
  final SharedPreferences sharedPreferences;
  DeactivateDesignation(this.httpClient, this.runSafely, this.sharedPreferences);

  ResultFuture<DesignationResponse> call({required int designationId,}) {
    return runSafely(
      () async {
        final response = await httpClient.post(
          "${Urls.deactivateDesignation1}$designationId${Urls.deactivateDesignation2}",
        );
