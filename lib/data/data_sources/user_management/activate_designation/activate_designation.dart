...
@lazySingleton
class ActivateDesignation {
  final HttpClient httpClient;
  final RunSafely runSafely;
  final SharedPreferences sharedPreferences;
  ActivateDesignation(this.httpClient, this.runSafely, this.sharedPreferences);

  ResultFuture<DesignationResponse> call({required int designationId,}) {
    return runSafely(
      () async {
        final response = await httpClient.post(
          "${Urls.activateDesignation1}$designationId${Urls.activateDesignation2}",
        );
