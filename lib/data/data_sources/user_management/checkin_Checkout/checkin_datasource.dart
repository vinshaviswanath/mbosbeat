...
class CheckinDatasource {
  ...
  CheckinDatasource(this.httpClient, this.runSafely, this.sharedPreferences);
  ResultFuture<DefaultResponse> call(BaseParams<CheckinParams> params) {
    return runSafely(
      () async {
        ...
        if (response.isOk) {
          ...
          Logger.logInfo("checkin response : ${data.toJson()}");
          return data;
        }
