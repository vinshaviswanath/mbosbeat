...
class ResetUserPassword {
  ...
  ResetUserPassword(this.httpClient, this.runSafely, this.sharedPreferences);

  ResultFuture<DesignationResponse> call(BaseParams<ResetUserPasswordParams> param) {
    return runSafely(
      () async {
        final response = await httpClient.postFormData(
        Urls.resetUserPassword,
        fields: param.toMap(),
      );
