...
@lazySingleton
class CreateGodownOrVehicle {
  final HttpClient httpClient;
  final RunSafely runSafely;
  final SharedPreferences sharedPreferences;
  CreateGodownOrVehicle(this.httpClient, this.runSafely, this.sharedPreferences);

  ResultFuture<GodownResponse> call(BaseParams<CreateGodownParams> param) {
    return runSafely(
      () async {
        ...
        if (response.isOk) {
          ...
          Logger.logInfo("Godown created response : ${data.toJson()}");
          return data;
        }
