...
class CreateVoucherNumbering {
  ...
  ResultFuture<CreateVoucherNumberingResponse> call(BaseParams<CreateVoucherNumberingParams> param) {
    return runSafely(
      () async {
        ...
        if (response.isOk) {
          final data = CreateVoucherNumberingResponse.fromJson(response.data);
