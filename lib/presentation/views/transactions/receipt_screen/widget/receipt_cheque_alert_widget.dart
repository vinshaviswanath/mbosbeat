...
class ReceiptChequeAlertWidget extends StatefulWidget {
  const ReceiptChequeAlertWidget({super.key});

  @override
  State<ReceiptChequeAlertWidget> createState() =>
      _ReceiptChequeAlertWidgetState();
}

class _ReceiptChequeAlertWidgetState extends State<ReceiptChequeAlertWidget> {
  String? _mode;
      ...
      child: Column(
        ...
        children: [
              ...
              SizedBox(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText:
                        appLocalizations.transaction_payment_screen_bank_name,
                    hintStyle: context.textStyle.s10.w500.dustyBlue.roboto,
                    isCollapsed: true,
          ...
          Row(
            ...
            children: [
              Text(
                appLocalizations.cheque_alert_instrument_no,
                style: context.textStyle.s10.w400.indigoBlue.roboto,
              ),
              SizedBox(
                width: context.getSize.width / 2.5,
                child: TextField(
                  ...
                  style: context.textStyle.s10.w500.indigoBlue.roboto,
                  decoration: InputDecoration(
                    hintText: appLocalizations.cheque_alert_instrument_no,
                    hintStyle: context.textStyle.s10.w500.dustyBlue.roboto,
                    isCollapsed: true,
                    contentPadding: const EdgeInsets.symmetric(
                      horizontal: 12,
          ...
          Row(
            ...
            children: [
              Text(
                appLocalizations.cheque_alert_instrument_date,
                style: context.textStyle.s10.w400.indigoBlue.roboto,
              ),
              SizedBox(
                width: context.getSize.width / 2.5,
                child: TextField(
                  ...
                  style: context.textStyle.s10.w500.indigoBlue.roboto,
                  decoration: InputDecoration(
                    hintText: appLocalizations.cheque_alert_instrument_date,
                    hintStyle: context.textStyle.s10.w500.dustyBlue.roboto,
                    isCollapsed: true,
                    contentPadding: const EdgeInsets.symmetric(
                      horizontal: 12,
