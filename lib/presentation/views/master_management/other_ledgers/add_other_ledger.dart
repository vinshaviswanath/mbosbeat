...
class AddOtherLedger extends StatefulWidget {
  // final int index;
  ...
  @override
  State<AddOtherLedger> createState() => _AddOtherLedgerState();
}

class _AddOtherLedgerState extends State<AddOtherLedger> {
          ...
          SliverPadding(
            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                ...
                h16,
                Text(
                  "Parent Group (Default Groups)",
                  style: context.textStyle.s12.bluishGray.w400.roboto,
                ),
                h4,
                CustomTextField(
                  hint: "Enter Parent Group",
                    ...
                    onTap: () {
                      setState(() {
                        ...
                        if (parentController.text.isEmpty) {
                          parentError = "Please enter Parent group";
                        }
                        if (nameError == null && parentError == null) {
