...
class ItemNameScreen extends StatefulWidget {
  const ItemNameScreen({super.key});

  @override
  State<ItemNameScreen> createState() => _ItemNameScreenState();
}

class _ItemNameScreenState extends State<ItemNameScreen> {
  int? selectedIndex;
  int? optionIndex;
              ...
              return Scaffold(
                ...
                appBar: AppBar(
                  ...
                  actions: [
                    InkWell(
                      onTap: () {
                        context.pushNamed(AppRouterConst.addItemName);
                      },
                      child: const Padding(
