...
class PartyNameScreen extends StatefulWidget {
  const PartyNameScreen({super.key});

  @override
  State<PartyNameScreen> createState() => _PartyNameScreenState();
}

class _PartyNameScreenState extends State<PartyNameScreen> {
  int? selectedIndex;
  int? optionIndex;
              ...
              return Scaffold(
                ...
                appBar: AppBar(
                  ...
                  actions: [
                    InkWell(
                      onTap: () {
                        context.pushNamed(AppRouterConst.addPartyName);
                      },
                      child: const Padding(
