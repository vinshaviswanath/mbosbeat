...
class DeleteRouteWidget extends StatelessWidget {
  final VoidCallback onDelete;

  const DeleteRouteWidget({super.key, required this.onDelete});
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Text(
          appLoaclizations.delete_route_widget_delete_route,
          style: context.textStyle.s14.w500.indigoBlue,
        ),
        h10,
        Text(
          appLoaclizations.delete_route_widget_are_you_sure,
                ...
                onTap: () {
                  ...
                  AppDetails.rootScaffoldMessengerKey.currentState
                      ?.showSnackBar(
                        SnackBar(
                          content: Text(
                            appLoaclizations.delete_route_widget_route_removed,
