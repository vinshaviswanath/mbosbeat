...
class ActivateRouteWidget extends StatelessWidget {
  final VoidCallback onActivate;

  const ActivateRouteWidget({super.key, required this.onActivate});
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            appLocatlizations.activate_route_widget_activate_route,
            style: context.textStyle.s14.w500.indigoBlue,
          ),
          h10,
          Text(
            appLocatlizations.activate_route_widget_are_you_sure,
