...
class VoucherB2CSettingsDialog extends StatefulWidget {
  final VoucherNumberingModel data;
  const VoucherB2CSettingsDialog({super.key, required this.data});

  @override
  State<VoucherB2CSettingsDialog> createState() =>
      _VoucherB2CSettingsDialogState();
}

class _VoucherB2CSettingsDialogState extends State<VoucherB2CSettingsDialog> {
  final _formKey = GlobalKey<FormState>();

  TextEditingController get prefixController =>
      TextEditingController(text: widget.data.b2CPrefix);
  TextEditingController get suffixController =>
      TextEditingController(text: widget.data.b2CSuffix);
  TextEditingController get widthController =>
      TextEditingController(text: widget.data.b2CSuffix.toString());
  TextEditingController get startFromController =>
      TextEditingController(text: widget.data.b2CStartFrom.toString());
