...
class UserManagementProvider with ChangeNotifier {
  ...
  Future<GodownResponse?> createGodown({
    ...
    setLoading(true);
    final result = await iUserManagementFacad.createGodown(
      BaseParams(
  ...
  Future<GodownListModel?> getAllGodowns({
    ...
    setLoading(true);
    final result = await iUserManagementFacad.getAllGodowns(
      companyId: companyId,
    );
  ...
  Future<GodownResponse?> activateGodown(
    ...
    setLoading(true);
    final result = await iUserManagementFacad.activateGodown(mid: mid);
  ...
  Future<GodownResponse?> deactivateGodown(
    ...
    setLoading(true);
    final result = await iUserManagementFacad.deactivateGodown(mid: mid);
  ...
  Future<GodownResponse?> deleteGodown(
    ...
    setLoading(true);
    final result = await iUserManagementFacad.deleteGodown(mid: mid);
  ...
  Future<RouteResponse?> createRoute({
    ...
    setLoading(true);
    final result = await iUserManagementFacad.createRoute(
      BaseParams(
  ...
  Future<RouteListModel?> getAllRoutess({
    ...
    setLoading(true);
    final result = await iUserManagementFacad.getRouteList(
      companyId: companyId,
    );
  ...
  Future<RouteResponse?> activateRoute(
    ...
    setLoading(true);
    final result = await iUserManagementFacad.activateRoute(routeId: routeId);
  ...
  Future<RouteResponse?> deactivateRoute(
    ...
    setLoading(true);
    final result = await iUserManagementFacad.deactivateRoute(routeId: routeId);
  ...
  Future<RouteResponse?> deleteRoute(
    ...
    setLoading(true);
    final result = await iUserManagementFacad.deleteRoute(
      routeId: routeId,
    );
    ...
    result.fold(
      ...
      (response) async {
        _routeResponse = response;
        Logger.logSuccess(
          "Route deleted successfull : ${response.toJson()}",
        );
        // getAllRoutess(context: context, companyId: companyId);
        notifyListeners();
      },
