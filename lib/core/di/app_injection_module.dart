...
abstract class AppInjectionModule {
  ...
  @lazySingleton
NetworkRepository get networkRepository => NetworkService();


@lazySingleton
NetworkProvider networkProvider(NetworkRepository repository) =>
    NetworkProvider(networkRepository: repository);
